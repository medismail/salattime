...
class PrayerTimes {
	 ...
	 */
	public const IMSAK = 'Imsak';
	public const FAJR = 'Fajr';
	public const SUNRISE = 'Sunrise';
	public const ZHUHR = 'Dhuhr';
	public const ASR = 'Asr';
	public const SUNSET = 'Sunset';
	public const MAGHRIB = 'Maghrib';
	public const ISHA = 'Isha';
	public const MIDNIGHT = 'Midnight';
	public const FIRST_THIRD = 'Firstthird';
	public const LAST_THIRD = 'Lastthird';
	public const MOONRISE = 'Moonrise';
	public const MOONSET = 'Moonset';

	/**
	 * Schools that determine the Asr shadow for the purpose of this class
	 */
	public const SCHOOL_STANDARD = 'STANDARD'; //0
	public const SCHOOL_HANAFI = 'HANAFI'; // 1

	/**
	 * Midnight Mode - how the midnight time is determined
	 */
	public const MIDNIGHT_MODE_STANDARD = 'STANDARD'; // Mid Sunset to Sunrise
	public const MIDNIGHT_MODE_JAFARI = 'JAFARI'; // Mid Sunset to Fajr

	/**
	 * Higher Latitude Adjustment Methods
	 */
	public const LATITUDE_ADJUSTMENT_METHOD_MOTN = 'MIDDLE_OF_THE_NIGHT'; // 1
	public const LATITUDE_ADJUSTMENT_METHOD_ANGLE = 'ANGLE_BASED'; // 3, angle/60th of night
	public const LATITUDE_ADJUSTMENT_METHOD_ONESEVENTH = 'ONE_SEVENTH'; // 2
	public const LATITUDE_ADJUSTMENT_METHOD_NONE = 'NONE'; // 0

	/**
	 * Formats in which data can be output
	 */
	public const TIME_FORMAT_24H = '24h'; // 24-hour format
	public const TIME_FORMAT_12H = '12h'; // 12-hour format
	public const TIME_FORMAT_12hNS = '12hNS'; // 12-hour format with no suffix
	public const TIME_FORMAT_FLOAT = 'Float'; // floating point number
	public const TIME_FORMAT_ISO8601 = 'iso8601';

	/**
	 * If we're unable to calculate a time, we'll return this
	 */
	public const INVALID_TIME = '-----';

	/**
	 * Next
	 */
	public const SALAT = 'Salat';
	public const REMAIN = 'Remain';
