...
class CalculationService {
        ...
        public function getPrayerTimes(string $userId): array {
                ...
                $times[PrayerTimes::HIJRI] = $this->l->t($hijri->get_day_name()) . ' ' . $hijri->get_day() . ' ' . $this->l->t($hijri->get_month_name()) . ' ' . $hijri->get_year() . 'H';
                $times[PrayerTimes::SALAT] = $next[PrayerTimes::SALAT];
                $times[PrayerTimes::REMAIN] = $next[PrayerTimes::REMAIN];
                $times[PrayerTimes::DAYLENGETH] = $pt->getDayLength($times[PrayerTimes::SUNRISE], $times[PrayerTimes::SUNSET]);
    ...
    public function gretNames(): array {
        return [
            ...
            'DAYLENGETH' => PrayerTimes::DAYLENGETH
            ];
    }
